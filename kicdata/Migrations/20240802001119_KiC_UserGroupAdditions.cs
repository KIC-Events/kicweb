...
{
    /// <inheritdoc />
    public partial class KiC_UserGroupAdditions : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "User",
                columns: new[] { "Id", "MemberId", "Password", "Username" },
                values: new object[] { new Guid("00000000-0000-0000-0000-000000000000"), 7725, "password", "admin" });
